...
const Event = ({ταυτότητα, μονός, μορφήΠεριβλήματος, μονόςΖυγόςΠάνωΓραμμή, χρώμαΕίδους, κείμενοΧρονολογίας, αριθμόςΗμερώνΕβδομάδωνΜηνώνΕτών, ημέρεςΕβδομάδεςΜήνεςΈτη, μονόςΖυγόςΔευτερεύουσαΓραμμή, κείμενοΔεδομένωνH3, μεΉΧωρίςΔευτερεύουσαΓραμμή, τύποςΔεδομένωνH6Βασικό, κείμενοΔεδομένωνH6Βασικό, κείμενοΔεδομένωνH6Δευτερεύον, τύποςΔεδομένωνH6Δευτερεύον, κείμενο, είδος, φωτογραφίαΠιστοποιητικού, ιστότοπος, τεχνολογίεςΓεγονότος}) => {
  
  const { language } = useAppContext();  

  const διάρκεια = `${αριθμόςΗμερώνΕβδομάδωνΜηνώνΕτών} ${μετάφραση(ημέρεςΕβδομάδεςΜήνεςΈτη, language)}`

...
export const metadata = {
  title: 'ΔΜ - Σχετικά με ιστότοπο',
  description: 'Λεπτομέρειες σχετικά με αυτόν τον ιστότοπο',
  keywords: ['Σχετικά με ιστότοπο', 'About this website', 'Om denna webbplats'],
        ...
        <div className={styles['περιέκτης-σχετικά']}>
          <p className={styles['κείμενο-σελίδας']}>
            <Μετάφραση>
              ...
              καινοτόμων διαδικτυακών εφαρμογών.
            </Μετάφραση>
          </p>
          <p className={styles['κείμενο-σελίδας']}>
            <Μετάφραση>
          ...
          <p className={styles['κείμενο-σελίδας']}>
            <Μετάφραση>
              ...
              μετάφραση και του μικρότερου κειμένου, δημιουργείται δυναμικά από

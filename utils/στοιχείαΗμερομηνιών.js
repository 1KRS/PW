...
const στοιχείαΗμερομηνιών = (έναρξη, λήξη) => {
  ...
  // console.log("Διαφορά", τρέχονΜήνας - μήναςΈναρξης, μελλοντικόΉΠαρελθοντικόΓεγονός)
  console.log(
    τρέχονΜήνας,
    τρέχονΈτος,
    μήναςΈναρξης,
  ...
  if (διάρκειαΓεγονότοςΣεΗμέρες === 'Δ/Δ') {
    ...
    ημέρεςΕβδομάδεςΜήνεςΈτη = 'Σε Εξέλιξη';
    ...
    {
      /* console.log('Στις ημέρες', αριθμόςΗμερώνΕβδομάδωνΜηνώνΕτών); */
    }
    αριθμόςΗμερώνΕβδομάδωνΜηνώνΕτών === 1

...
const μετάφραση = (κείμενο, γλώσσα) => {
  ...
  if (κείμενο === null || κείμενο === undefined || κείμενο === '') {
  ...
  if (δείκτηςΑντικειμένου === null || δείκτηςΑντικειμένου === undefined || δείκτηςΑντικειμένου === '' || δείκτηςΑντικειμένου === 0 || δείκτηςΑντικειμένου === -1) {
  ...
  const έννοιαΣεΓλώσσα =
    γλώσσα.toLowerCase() === 'english'
      ? έννοιες[δείκτηςΑντικειμένου].αγγλικά ? έννοιες[δείκτηςΑντικειμένου].αγγλικά : console.log(`❗️ Δεν βρέθηκε η μετάφραση του «${κείμενο}» στα ${γλώσσα}.`)
      : γλώσσα.toLowerCase() === 'svenska'
      ? έννοιες[δείκτηςΑντικειμένου].σουηδικά ? έννοιες[δείκτηςΑντικειμένου].σουηδικά : console.log(`❗️ Δεν βρέθηκε η μετάφραση του «${κείμενο}» στα ${γλώσσα}.`)
      : έννοιες[δείκτηςΑντικειμένου].ελληνικά ? έννοιες[δείκτηςΑντικειμένου].ελληνικά : console.log(`❗️ Δεν βρέθηκε η μετάφραση του «${κείμενο}» στα ${γλώσσα}.`)

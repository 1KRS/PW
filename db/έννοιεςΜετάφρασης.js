export const έννοιες = [
  ...
  {
    ελληνικά: 'Νέα ιδέα σε εξέλιξη',
    αγγλικά: 'New idea in progress',
    σουηδικά: 'Ny idé under utveckling',
  },
  ...
  {
    ελληνικά: 'Σύγχρονη JavaScript 2025',
    αγγλικά: 'Modern JavaScript 2025',
    σουηδικά: 'Modern JavaScript 2025',
  },
  {
    ελληνικά: 'Συμβουλευτική',
    αγγλικά: 'Consulting',
    σουηδικά: 'Konsultation',
  },
  {
    ελληνικά:
